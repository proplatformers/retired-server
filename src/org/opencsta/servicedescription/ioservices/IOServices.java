...
public class IOServices extends CSTA_Layer_7_Common{
    ...
    private void Init(){
        try{
            ...
            if( tmp_props.getProperty("BEHAVIOUR_APP_ET").toUpperCase().equals("TRUE") )
    ...
    public void StartDataPathReceived(StringBuffer curInStr, String inv_id){
        ...
        //PNA NURSE APPLICATION - ONLY IF FLAG IS SET IN IOSERVICESBEHAVIOUR FILE
        if( earlyTermination == true ){
            System.out.println("Early Termination == true ") ;
            //MUST SEND THE TDS CODE AND DEVICE TO THE LAYER 7 TO PASS ON TO CLIENT VIA SERVER
    ...
    public void StopDataPath(String ioXref){
        ...
        strbuf = strbuf.insert(0, ioXref).insert(0,(char)0x01).insert(0,(char)0x04) ;
     ...
     * @param inv_id
     */
    public void StartDataPathResponse(String device, String TDScode, String inv_id){
    ...
    public void TDSSendDataReceived(StringBuffer curInStr, String invoke_id_ref){
        ...
        //MUST SEND THE DATA THAT WAS 'DATA-ED' TO THE CLIENT, SO THE APPLICATION
    ...
    public StringBuffer escapeService_TDSStart(){
        ...
        char[] tdsstartchararray = {0xE1, 0x0E, 0x06, 0x06, 0x2B, 0x0C, 0x02, 0x88, 0x53,
                0x0F, 0x04, 0x04, 0x1A, 0x04, 0x01, 0xC0} ;
