...
public abstract class CSTA_Link implements Runnable, CSTA_Link_Interface {
	 ...
	 * 
	 */
	private String[] status = { "Initialised", "ASN1 Connector Down",
			"ASN1 Connector Up", "ACSE Abort Sent, Waiting Response",
			"ACSE Abort Response Received, Link Up", "Unknown" };
	...
	public void threaden() {
		throw new UnsupportedOperationException(
				"Not supported here, please override in subclass");
	}
	 ...
	 * 
	 * @see
	 * org.opencsta.link.CSTA_Link_Interface#commandIn(java.lang.StringBuffer)
	 */
	...
	public boolean isLinkUp() {
		if (isCleanStart()) {
			...
			// @todo when an interrupted csta link thingy goes down, needs some
			// work prolly
		}
		return linkUp;
	}
	...
	/**
	 * @param loginASN1ConnectorStartSent
	 *            the loginASN1ConnectorStartSent to set
	 */
	public void setLoginASN1ConnectorStartSent(
			boolean loginASN1ConnectorStartSent) {
	...
	/**
	 * @param loginASN1ConnectorStartResponse
	 *            the loginASN1ConnectorStartResponse to set
	 */
	public void setLoginASN1ConnectorStartResponse(
			boolean loginASN1ConnectorStartResponse) {
	...
	/**
	 * @param loginACSEAbortSent
	 *            the loginACSEAbortSent to set
	 */
	...
	/**
	 * @param loginACSEAbortResponseReceived
	 *            the loginACSEAbortResponseReceived to set
	 */
	public void setLoginACSEAbortResponseReceived(
			boolean loginACSEAbortResponseReceived) {
	 ...
	 * 
	 * @see
	 * org.opencsta.link.CSTA_Link_Interface#newMessageIn(org.opencsta.link.
	 * tmp_CSTATCPClient)
	 */
	...
	public void killThreads() {
		alog.info(this.getClass().getName()
				+ " CSTA LINK Thread Pool is shutting down");
		threadExecutor.shutdown();
		alog.info(this.getClass().getName()
				+ " Done shutting down CSTA LINK thread pool");
	}
