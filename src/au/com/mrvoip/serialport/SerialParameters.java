 ...
 * 
 * @author chrismylonas borrowed from some old source code for serial ports in
 *         java
 */
public class SerialParameters {
	...
	/**
	 * Default constructer. Sets parameters to ttyS0 *no port*, 19200 baud, no
	 * flow control, 8 data bits, 1 stop bit, no parity.
	 */
	...
	public SerialParameters(String portName, int baudRate) {
		this(portName, baudRate, SerialPort.FLOWCONTROL_RTSCTS_IN,
				SerialPort.FLOWCONTROL_RTSCTS_OUT, SerialPort.DATABITS_8,
