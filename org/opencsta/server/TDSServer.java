...
public class TDSServer {
    ...
    public void NewTDStransmission(String ioXref, String device, String TDScode){
    	alog.info("TDSServer creating a TDS Object for device: " + device + " code: " + TDScode ) ;
    ...
    /**
     * this method is used for early termination when ioservices are used for basepage
     *
     *
     * @param dev
     * @param code
    ...
    public void TDSEarlyTerminationDataToClients(String dev,String code){
        //IN THIS METHOD 0x98 IS USED TO INDICATE THAT IT IS AN EARLY TERM. TDS MESSAGE
